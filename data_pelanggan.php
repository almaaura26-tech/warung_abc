...
$sql = "SELECT * FROM tbl_pelangan ORDER BY nama_pelanggan ASC";
...
<html>
    ...
    <body>
        ...
        <p><a href="dashboard.php">kemabli ke dashboard</a>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="hapus_pelanggan.phpp?id=<?php echo $row['id_pelanggan'];">
